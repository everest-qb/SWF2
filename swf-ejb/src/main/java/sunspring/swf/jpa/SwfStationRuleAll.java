...
public class SwfStationRuleAll implements Serializable {
	...
	@Id
	@SequenceGenerator(name="SWF_STATION_RULE_ALL_STATIONRULEID_GENERATOR", sequenceName="SWF_STATION_RULE_ALL_S1",schema="SWF",allocationSize=1)
	...
	@XmlTransient
	@OneToMany(mappedBy="swfStationRule",orphanRemoval = true, cascade = ALL, fetch = EAGER)
