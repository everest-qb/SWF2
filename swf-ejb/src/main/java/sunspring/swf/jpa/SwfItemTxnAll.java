...
/*	@Transient
	...
	@XmlTransient
	@ManyToOne
	@JoinColumn(name = "HDR_ID", table = "SWF_ITEM_TXN_ALL", referencedColumnName = "HDR_ID")
	private SwfItemHdrAll itemHdr;

	@Id
	@SequenceGenerator(name="SWF_ITEM_TXN_ALL_ITEMTXNID_GENERATOR", sequenceName="SWF_ITEM_TXN_ALL_S1",schema="SWF",allocationSize=1)
	...
	@OneToOne
	@JoinColumn(name = "STATION_ID", referencedColumnName = "STATION_ID", table = "SWF_ITEM_TXN_ALL")
